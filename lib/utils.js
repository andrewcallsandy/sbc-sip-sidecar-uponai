...
function isValidDomainOrIP(input) {
  // Allow underscores in domain names for SIP URIs (RFC 3261 allows user-unreserved characters)
  // This is more permissive than strict DNS rules, but appropriate for SIP from_domain headers
  const domainRegex = /^(?!:\/\/)([a-zA-Z0-9._-]+)(:\d+)?$/;
