...
const FAILURE_RETRY_INTERVAL = (parseInt(JAMBONES_REGBOT_FAILURE_RETRY_INTERVAL) || 30);
    ...
    try {
      ...
      req.on('response', async(res) => {
        ...
        if (res.status !== 200) {
          ...
          if (REGISTER_RESPONSE_REMOVE.includes(res.status) && this.consecutiveFailures >= 6) {
