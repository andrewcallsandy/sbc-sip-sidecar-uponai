...
const JAMBONES_REGISTRATION_WEBHOOK_URL = process.env.JAMBONES_REGISTRATION_WEBHOOK_URL;

/* BLF / Live Extension Availability (Phase 1) — off by default */
const JAMBONES_BLF_ENABLED = process.env.JAMBONES_BLF_ENABLED === '1'
  || process.env.JAMBONES_BLF_ENABLED === 'true';
const JAMBONES_BLF_RECONCILE_SECONDS = process.env.JAMBONES_BLF_RECONCILE_SECONDS;
const JAMBONES_BLF_STATE_LEAD_SECONDS = process.env.JAMBONES_BLF_STATE_LEAD_SECONDS;
const API_INTERNAL_BASE_URL = process.env.API_INTERNAL_BASE_URL;
const JAMBONES_INTERNAL_TOKEN = process.env.JAMBONES_INTERNAL_TOKEN;
